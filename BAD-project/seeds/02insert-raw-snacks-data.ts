...
//-------------------------------------------------------------------------------------------
  ...
  const pk = (await workbookToJSON("./data/snacks_20220814.xlsx", "pk_snacks")) as Product[];
  ...
  logger.info("snacks: PK data inserted");
  ...
  logger.info("snacks: zstore data inserted");
  ...
  logger.info("snacks: aeon data inserted");
