...
export async function seed(knex: Knex): Promise<void> {
  ...
  const pk = (await workbookToJSON("./data/drinks.xlsx", "PK")) as Product[];
  ...
  logger.info("drinks: PK data inserted");
  ...
  logger.info("drinks: zstore data inserted");
  ...
  logger.info("drinks: aeon data inserted");
}
